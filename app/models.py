...
# ==========================================
# 2. ESTRUTURA DA LOJA E CATEGORIAS
# ==========================================
...
class Loja(models.Model):
    ...
    cep = models.CharField(max_length=9, verbose_name="CEP da Loja", default="00000-000")  # Mantido para logística
...
class Produto(models.Model):
    ...
    # Campos Financeiros Combinados (Com labels claros e valores padrão seguros)
    ...
    # Imagem opcional para evitar quebras se o vendedor não subir foto de início
    imagem = models.ImageField(upload_to='produtos/', blank=True, null=True) 
    especificacoes = models.TextField(help_text="Ex: RAM, CPU, Versão do Software")
    
    # Linha do tempo mantida para auditoria e controle de novidades
    ...
    # --- Métricas e KPIs (Ajustadas para performance limpa) ---
    def calcular_margem_abs(self):
        """Calcula o lucro bruto em Reais (Preço - Custo)"""
    ...
    def valor_total_estoque(self):
        """KPI Logístico: Total de capital imobilizado neste produto"""
        return self.preco_custo * self.estoque

# ==========================================
# 4. INTERAÇÃO, VENDAS E FAVORITOS
# ==========================================
...
class Avaliacao(models.Model):
    ...
    class Meta:
        ...
        unique_together = ('usuario', 'produto')  # Garante apenas 1 avaliação por cliente por produto

    def __str__(self):
        return f"Nota {self.nota} para {self.produto.nome} por {self.usuario.username}"
